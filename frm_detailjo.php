...
LEFT JOIN m_cust c ON t.`idcust`=c.`id_cust` where nojo='$_GET[idjo]'");
			...
			<tr> <td> <b> Qty Ok  </b> </td><td> :  </td><td> <input type="text" value="<?=$datatampil['qty']-$datatampil['ng']?>"  id="txgr" name="txgr" class="small required"/> </td> <td> <b>Qty NG</b> </td><td> :  </td><td> <input type="text" value="<?=$datatampil['ng']?>"  id="txng" name="txng" class="small required"/> </td> </tr>
			</table>
			</fieldset>
					<fieldset>
